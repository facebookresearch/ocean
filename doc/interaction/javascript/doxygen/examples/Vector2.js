 ...
 * This JavaScript file test the ocean scripting support for the Vector2 object.
 */
...
{
	ocean.info("JavaScript Vector2 test: ");

	ocean.info(" ");
	var vector0 = new Vector2(1, 2);
	var vector1 = new Vector2(10, 11.5);
	ocean.info("vector0 (x, y): (", vector0.string(), ")");
	ocean.info("vector1 (x, y): (", vector1.string(), ")");
