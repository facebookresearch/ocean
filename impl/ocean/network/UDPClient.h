...
#ifndef FACEBOOK_NETWORK_UDP_CLIENT_H
#define FACEBOOK_NETWORK_UDP_CLIENT_H
 ...
 * @ingroup network
 */
class OCEAN_NETWORK_EXPORT UDPClient : virtual public ConnectionlessClient
{
	public:
...
#endif // FACEBOOK_NETWORK_UDP_SOCKET_H
