...
RMVTracker6DOF::ObjectId RMVTracker6DOF::registerObject(const std::string& description, const Vector3& dimension)
{
	...
	if (pinholeCamera)
	{
		...
		Tracking::RMV::RMVFeatureDetector::DetectorType initilizationDetectorType = Tracking::RMV::RMVFeatureDetector::DT_BLOB_FEATURE;

		const unsigned int numberMapPoints = 300u;
		const unsigned int numberInitializationPoints = 90u; // Blob
		//const unsigned int numberInitializationPoints = 120u; // non-Blob
		...
		const unsigned int numberInitializationPoints = 150u; // Blob
		//const unsigned int numberInitializationPoints = 120u; // non-Blob
