...
{
	using Callback0 = Ocean::Callback<void>;
	using Callback1 = Ocean::Callback<void, int>;
	using Callback2 = Ocean::Callback<void, int, int>;
	using Callback3 = Ocean::Callback<void, int, int, int>;
	using Callback4 = Ocean::Callback<void, int, int, int, int>;
	using Callback5 = Ocean::Callback<void, int, int, int, int, int>;
	using Callback6 = Ocean::Callback<void, int, int, int, int, int, int>;
	using Callback7 = Ocean::Callback<void, int, int, int, int, int, int, int>;
	using Callback8 = Ocean::Callback<void, int, int, int, int, int, int, int, int>;
	using Callback9 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int>;
	using Callback10 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int>;
	using Callback11 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int>;
	using Callback12 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int, int>;
	using Callback13 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using Callback14 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using Callback15 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using Callback16 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using Callback17 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using Callback18 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using Callback19 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using Callback20 = Ocean::Callback<void, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;

	using CallbackInt0 = Ocean::Callback<int>;
	using CallbackInt1 = Ocean::Callback<int, int>;
	using CallbackInt2 = Ocean::Callback<int, int, int>;
	using CallbackInt3 = Ocean::Callback<int, int, int, int>;
	using CallbackInt4 = Ocean::Callback<int, int, int, int, int>;
	using CallbackInt5 = Ocean::Callback<int, int, int, int, int, int>;
	using CallbackInt6 = Ocean::Callback<int, int, int, int, int, int, int>;
	using CallbackInt7 = Ocean::Callback<int, int, int, int, int, int, int, int>;
	using CallbackInt8 = Ocean::Callback<int, int, int, int, int, int, int, int, int>;
	using CallbackInt9 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt10 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt11 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt12 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt13 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt14 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt15 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt16 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt17 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt18 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt19 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
	using CallbackInt20 = Ocean::Callback<int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>;
