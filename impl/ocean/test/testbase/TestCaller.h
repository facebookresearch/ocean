...
#ifndef META_OCEAN_TEST_TESTBASE_TEST_CALLER_H
 ...
 * @ingroup testbase
 */
class OCEAN_TEST_BASE_EXPORT TestCaller
{
	protected:
		...
		class Object
		{
			public:
				 ...
				 * @param parameter0 An integer parameter, which will be increased by one (while it is not a reference)
				 * @param parameter1 A boolean parameter, which will be inverted (while it is a pointer)
				 * @param parameter2 A float parameter, which will be increated by 10 (while it is a pointer)
				 * @param parameter3 A string parameter, which will be cleared (while it is not a reference)
				 ...
				 * @param parameter1 A boolean parameter, which will be inverted (while it is a pointer)
				 * @param parameter2 A float parameter, which will be increated by 10 (while it is a pointer)
				 * @param parameter3 A double parameter, which will be increated by 20 (while it is a reference)
				 * @param parameter4 A string parameter, which will be cleared (while it is not a reference)
				 * @param parameter5 A string parameter, which will be mirrored (while it is a reference)
				 * @param parameter6 A constant object parameter as reference
				 * @return Returns -1 always
				 */
...
#endif // META_OCEAN_TEST_TESTBASE_TEST_CALLER_H
