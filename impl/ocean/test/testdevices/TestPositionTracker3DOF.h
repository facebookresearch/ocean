...
#ifndef META_OCEAN_TEST_TESTDEVICES_TEST_POSITION_TRACKER_3DOF_H
#define META_OCEAN_TEST_TESTDEVICES_TEST_POSITION_TRACKER_3DOF_H
...
/**
 * This class implements tests for the PositionTracker3DOF class.
 * @ingroup testdevices
 */
class OCEAN_TEST_DEVICES_EXPORT TestPositionTracker3DOF
{
	public:
...
#endif // META_OCEAN_TEST_TESTDEVICES_TEST_POSITION_TRACKER_3DOF_H
