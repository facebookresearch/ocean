	...
	for (const bool useGravityConstraints : {false, true})
	{
		...
		do
		{
			...
			if (result)
			{
				...
				gravityErrors.push_back(Numeric::rad2deg(gravityConstraints.alignmentAngle(world_T_optimizedCamera1, 1)));
