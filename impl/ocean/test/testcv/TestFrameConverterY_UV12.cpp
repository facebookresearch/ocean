...
TEST(TestFrameConverterY_UV12, Y_UV12LimitedRangeToY8LimitedRangeNormal)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8LimitedRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_NORMAL, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12LimitedRangeToY8LimitedRangeFlipped)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8LimitedRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_FLIPPED, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12LimitedRangeToY8LimitedRangeMirrored)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8LimitedRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_MIRRORED, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12LimitedRangeToY8LimitedRangeFlippedMirrored)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8LimitedRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_FLIPPED_AND_MIRRORED, GTEST_TEST_DURATION, worker));
}


TEST(TestFrameConverterY_UV12, Y_UV12LimitedRangeToY8FullRangeNormal)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8FullRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_NORMAL, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12LimitedRangeToY8FullRangeFlipped)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8FullRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_FLIPPED, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12LimitedRangeToY8FullRangeMirrored)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8FullRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_MIRRORED, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12LimitedRangeToY8FullRangeFlippedMirrored)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8FullRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_FLIPPED_AND_MIRRORED, GTEST_TEST_DURATION, worker));
}


TEST(TestFrameConverterY_UV12, Y_UV12FullRangeToY8FullRangeNormal)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12FullRangeToY8FullRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_NORMAL, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12FullRangeToY8FullRangeFlipped)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12FullRangeToY8FullRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_FLIPPED, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12FullRangeToY8FullRangeMirrored)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12FullRangeToY8FullRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_MIRRORED, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12FullRangeToY8FullRangeFlippedMirrored)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12FullRangeToY8FullRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_FLIPPED_AND_MIRRORED, GTEST_TEST_DURATION, worker));
}


TEST(TestFrameConverterY_UV12, Y_UV12FullRangeToY8LimitedRangeNormal)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12FullRangeToY8LimitedRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_NORMAL, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12FullRangeToY8LimitedRangeFlipped)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12FullRangeToY8LimitedRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_FLIPPED, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12FullRangeToY8LimitedRangeMirrored)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12FullRangeToY8LimitedRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_MIRRORED, GTEST_TEST_DURATION, worker));
}

TEST(TestFrameConverterY_UV12, Y_UV12FullRangeToY8LimitedRangeFlippedMirrored)
{
	Worker worker;
	EXPECT_TRUE(TestFrameConverterY_UV12::testY_UV12FullRangeToY8LimitedRange(GTEST_TEST_IMAGE_WIDTH, GTEST_TEST_IMAGE_HEIGHT, CV::FrameConverter::CONVERT_FLIPPED_AND_MIRRORED, GTEST_TEST_DURATION, worker));
}
...
bool TestFrameConverterY_UV12::testY_UV12LimitedRangeToBGR24FullRange(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12_LIMITED_RANGE, FrameType::FORMAT_BGR24, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12LimitedRangeToBGR24FullRange), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker, thresholdMaximalErrorToInteger);
}
...
bool TestFrameConverterY_UV12::testY_UV12LimitedRangeToRGB24FullRange(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12_LIMITED_RANGE, FrameType::FORMAT_RGB24, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12LimitedRangeToRGB24FullRange), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker, thresholdMaximalErrorToInteger);
}
...
bool TestFrameConverterY_UV12::testY_UV12FullRangeToBGR24FullRange(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12_FULL_RANGE, FrameType::FORMAT_BGR24, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12FullRangeToBGR24FullRange), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker, thresholdMaximalErrorToInteger);
}
...
bool TestFrameConverterY_UV12::testY_UV12FullRangeToRGB24FullRange(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12_FULL_RANGE, FrameType::FORMAT_RGB24, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12FullRangeToRGB24FullRange), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker, thresholdMaximalErrorToInteger);
}
...
bool TestFrameConverterY_UV12::testY_UV12ToYUV24(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12, FrameType::FORMAT_YUV24, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12ToYUV24), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker);
}
...
bool TestFrameConverterY_UV12::testY_UV12ToYVU24(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12, FrameType::FORMAT_YVU24, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12ToYVU24), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker);
}
...
bool TestFrameConverterY_UV12::testY_UV12ToY8(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12, FrameType::FORMAT_Y8, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12ToY8), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker);
}

bool TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8LimitedRange(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	ocean_assert(testDuration > 0.0);
	ocean_assert(width != 0u && height != 0u);
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12_LIMITED_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12LimitedRangeToY8LimitedRange), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker);
}

bool TestFrameConverterY_UV12::testY_UV12LimitedRangeToY8FullRange(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	ocean_assert(testDuration > 0.0);
	ocean_assert(width != 0u && height != 0u);
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12_LIMITED_RANGE, FrameType::FORMAT_Y8_FULL_RANGE, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12LimitedRangeToY8FullRange), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker);
}

bool TestFrameConverterY_UV12::testY_UV12FullRangeToY8FullRange(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	ocean_assert(testDuration > 0.0);
	ocean_assert(width != 0u && height != 0u);
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12_FULL_RANGE, FrameType::FORMAT_Y8_FULL_RANGE, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12FullRangeToY8FullRange), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker);
}

bool TestFrameConverterY_UV12::testY_UV12FullRangeToY8LimitedRange(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	ocean_assert(testDuration > 0.0);
	ocean_assert(width != 0u && height != 0u);
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12_FULL_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12FullRangeToY8LimitedRange), conversionFlag, pixelFunctionY_UV12ForYUV24, FrameConverterTestUtilities::functionGenericPixel, transformationMatrix, 0.0, 255.0, testDuration, worker);
}
...
bool TestFrameConverterY_UV12::testY_UV12ToY_U_V12(const unsigned int width, const unsigned int height, const CV::FrameConverter::ConversionFlag conversionFlag, const double testDuration, Worker& worker)
{
	...
	return FrameConverterTestUtilities::testFrameConversion(FrameType::FORMAT_Y_UV12, FrameType::FORMAT_Y_U_V12, width, height, FrameConverterTestUtilities::FunctionWrapper(CV::FrameConverterY_UV12::convertY_UV12ToY_U_V12), conversionFlag, pixelFunctionY_UV12ForYUV24, pixelFunctionY_U_V12ForYUV24, transformationMatrix, 0.0, 255.0, testDuration, worker);
}
