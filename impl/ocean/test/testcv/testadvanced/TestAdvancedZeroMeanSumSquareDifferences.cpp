...
bool TestAdvancedZeroMeanSumSquareDifferences::test(const double testDuration)
{
	...
	allSucceeded = testPartialTwoMasksTwoCounts(testDuration) && allSucceeded;
...
bool TestAdvancedZeroMeanSumSquareDifferences::testPartialTwoMasks(const double testDuration)
{
	...
	allSucceeded = testPartialTwoMasks<1u>(1280u, 720u, 1280u, 720u, 10u, 10u, testDuration);
	...
	allSucceeded = testPartialTwoMasks<2u>(1280u, 720u, 1280u, 720u, 10u, 10u, testDuration);
	...
	allSucceeded = testPartialTwoMasks<3u>(1280u, 720u, 1280u, 720u, 10u, 10u, testDuration);
	...
	allSucceeded = testPartialTwoMasks<4u>(1280u, 720u, 1280u, 720u, 10u, 10u, testDuration);
...
bool TestAdvancedZeroMeanSumSquareDifferences::testPartialTwoMasks(const unsigned int width0, const unsigned int height0, const unsigned int width1, const unsigned int height1, const unsigned int sizeX, const unsigned int sizeY, const double testDuration)
{
	...
	LegacyFrame maskFrame1(FrameType(width1, height1, FrameType::FORMAT_Y8, FrameType::ORIGIN_LOWER_LEFT));
	...
	{
		left0[n] = RandomI::random(-int(sizeX) + 1, int(width0 - 1u));
		top0[n] = RandomI::random(-int(sizeY) + 1, int(height0 - 1u));

		left1[n] = RandomI::random(-int(sizeX) + 1, int(width1 - 1u));
		top1[n] = RandomI::random(-int(sizeY) + 1, int(height1 - 1u));
	}

	HighPerformanceStatistic performance;

	unsigned int dummy0 = 0u;
	unsigned int dummy1 = 0u;

	const Timestamp startTimestamp(true);

	do
	{
		const HighPerformanceStatistic::ScopedStatistic scopedStatistic(performance);

		for (unsigned int n = 0u; n < constRepetitions; ++n)
		{
			const std::pair<unsigned int, unsigned int> result = CV::Advanced::AdvancedZeroMeanSumSquareDifferencesBase::determine8BitPerChannelPartialTemplate<tChannels>(data0, data1, mask0, mask1, width0, height0, width1, height1, sizeX, sizeY, left0[n], top0[n], left1[n], top1[n]);
			dummy0 += result.first;
			dummy1 += result.second;
		}
	}
	while (startTimestamp + testDuration > Timestamp(true));

	if (dummy0 + dummy1 == 0xFFFFFFFFu)
	...
	const bool validation = validatePartialTwoMasks<tChannels>(data0, data1, mask0, mask1, width0, height0, width1, height1, sizeX, sizeY, testDuration);
...
bool TestAdvancedZeroMeanSumSquareDifferences::testPartialTwoMasksTwoCounts(const double testDuration)
{
	...
	allSucceeded = testPartialTwoMasksTwoCounts<1u>(640u, 480u, 640u, 480u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<1u>(641u, 477u, 640u, 480u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<1u>(640u, 481u, 645u, 483u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<1u>(1280u, 720u, 1280u, 720u, 10u, 10u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<1u>(1280u, 720u, 1280u, 720u, 31u, 31u, testDuration);

	Log::info() << " ";

	allSucceeded = testPartialTwoMasksTwoCounts<2u>(640u, 480u, 640u, 480u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<2u>(641u, 477u, 640u, 480u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<2u>(640u, 481u, 645u, 483u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<2u>(1280u, 720u, 1280u, 720u, 10u, 10u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<2u>(1280u, 720u, 1280u, 720u, 31u, 31u, testDuration);

	Log::info() << " ";

	allSucceeded = testPartialTwoMasksTwoCounts<3u>(640u, 480u, 640u, 480u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<3u>(641u, 477u, 640u, 480u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<3u>(640u, 481u, 645u, 483u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<3u>(1280u, 720u, 1280u, 720u, 10u, 10u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<3u>(1280u, 720u, 1280u, 720u, 31u, 31u, testDuration);

	Log::info() << " ";

	allSucceeded = testPartialTwoMasksTwoCounts<4u>(640u, 480u, 640u, 480u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<4u>(641u, 477u, 640u, 480u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<4u>(640u, 481u, 645u, 483u, 5u, 5u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<4u>(1280u, 720u, 1280u, 720u, 10u, 10u, testDuration);
	allSucceeded = testPartialTwoMasksTwoCounts<4u>(1280u, 720u, 1280u, 720u, 31u, 31u, testDuration);

	return allSucceeded;
}

template <unsigned int tChannels>
bool TestAdvancedZeroMeanSumSquareDifferences::testPartialTwoMasksTwoCounts(const unsigned int width0, const unsigned int height0, const unsigned int width1, const unsigned int height1, const unsigned int sizeX, const unsigned int sizeY, const double testDuration)
{
	Log::info() << "Test " << tChannels * 8u << " bit counts and masked with (" << width0 << "x" << height0 << ", " << width1 << "x" << height1 << ") and patch size " << sizeX << "x" << sizeY << ":";
	...
	do
	{
		...
		for (unsigned int n = 0u; n < constRepetitions; ++n)
		{
			unsigned int pixels0, pixels1;
			dummy0 += CV::Advanced::AdvancedZeroMeanSumSquareDifferencesBase::determine8BitPerChannelPartialTemplate<tChannels>(data0, data1, mask0, mask1, width0, height0, width1, height1, sizeX, sizeY, left0[n], top0[n], left1[n], top1[n], pixels0, pixels1);
	...
	if (dummy0 + dummy1 + dummy2 == 0xFFFFFFFFu)
		Log::info() << "Performance of " << String::insertCharacter(String::toAString(constRepetitions), ',', 3, false) << " repetitions: " << performance.averageMseconds() << "ms";
	else
		Log::info() << "Performance of " << String::insertCharacter(String::toAString(constRepetitions), ',', 3, false) << " repetitions: " << performance.averageMseconds() << "ms";

	const bool validation = validatePartialTwoMasksTwoCounts<tChannels>(data0, data1, mask0, mask1, width0, height0, width1, height1, sizeX, sizeY, testDuration);
...
template <unsigned int tChannels>
bool TestAdvancedZeroMeanSumSquareDifferences::validatePartialTwoMasksTwoCounts(const unsigned char* frame0, const unsigned char* frame1, const unsigned char* mask0, const unsigned char* mask1, const unsigned int width0, const unsigned int height0, const unsigned int width1, const unsigned int height1, const unsigned int sizeX, const unsigned int sizeY, const double testDuration)
{
	const Timestamp startTimestamp(true);
	...
	do
	{
		...
		unsigned int resultPixels0, resultPixels1;
		const unsigned int result = CV::Advanced::AdvancedZeroMeanSumSquareDifferencesBase::determine8BitPerChannelPartialTemplate<tChannels>(frame0, frame1, mask0, mask1, width0, height0, width1, height1, sizeX, sizeY, left0, top0, left1, top1, resultPixels0, resultPixels1);
		...
		for (int y0 = top0; y0 < top0 + int(sizeY); ++y0)
		{
			...
			for (int x0 = left0; x0 < left0 + int(sizeX); ++x0)
			{
				if (x0 >= 0 && x0 <= int(width0 - 1u) && y0 >= 0 && y0 <= int(height0 - 1u))
				{
					if (mask0[y0 * width0 + x0] == 0xFF)
					{
						if (x1 >= 0 && x1 <= int(width1 - 1u) && y1 >= 0 && y1 <= int(height1 - 1u))
						{
							if (mask1[y1 * width1 + x1] == 0xFF)
							{
								meanPixels++;
		...
		unsigned int testPixels0 = 0u;
		unsigned int testPixels1 = 0u;
		...
		ocean_assert(testPixels0 >= testPixels1);

		if (result != test || resultPixels0 != testPixels0 || resultPixels1 != testPixels1)
			return false;
	}
	while (startTimestamp + testDuration > Timestamp(true));
