...
bool TestFrameFilterScharrMagnitude::test(const unsigned int width, const unsigned int height, const double testDuration, Worker& worker, const TestSelector& selector)
{
	ocean_assert(testDuration > 0.0);

	TestResult testResult("Scharr Magnitude filter test");
	Log::info() << " ";
