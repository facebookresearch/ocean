...
bool TestPlane3::testConstructorThreePoints(const double testDuration)
{
	...
	do
	{
		for (unsigned int n = 0u; n < 1000u; ++n)
		{
			...
			const Vector3 objectPoint(Random::vector3(-100, 100));
		...
		for (unsigned int n = 0u; n < 1000u; ++n)
		{
			...
			const Vector3 objectPoint0(Random::vector3(-100, 100));
			const Vector3 objectPoint1(Random::vector3(-100, 100));
		...
		for (unsigned int n = 0u; n < 1000u; ++n)
		{
			...
			const Scalar range = std::is_same<Scalar, float>::value ? Scalar(5) : Scalar(100);
			...
			if (objectPoint0 != objectPoint1 && objectPoint0 != objectPoint2 && objectPoint1 != objectPoint2)
			{
