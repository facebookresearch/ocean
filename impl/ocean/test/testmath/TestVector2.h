...
#ifndef META_OCEAN_TEST_TESTMATH_TEST_VECTOR_2_H
#define META_OCEAN_TEST_TESTMATH_TEST_VECTOR_2_H
 ...
 * @ingroup testmath
 */
class OCEAN_TEST_MATH_EXPORT TestVector2
{
	public:
		 ...
		 * @param testDuration The number of second for each test
		 * @return True, if succeeded
		 */
...
#endif // META_OCEAN_TEST_TESTMATH_TEST_VECTOR_2_H
