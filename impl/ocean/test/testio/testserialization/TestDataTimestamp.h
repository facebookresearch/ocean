...
#ifndef META_OCEAN_TEST_TESTIO_TESTSERIALIZATION_TEST_DATA_TIMESTAMP_H
#define META_OCEAN_TEST_TESTIO_TESTSERIALIZATION_TEST_DATA_TIMESTAMP_H
 ...
 */
class OCEAN_TEST_IO_SERIALIZATION_EXPORT TestDataTimestamp
{
	public:
...
#endif // META_OCEAN_TEST_TESTIO_TESTSERIALIZATION_TEST_DATA_TIMESTAMP_H
