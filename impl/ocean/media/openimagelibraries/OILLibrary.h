...
#ifndef META_OCEAN_MEDIA_OPEN_IMAGE_LIBRARIES_OL_LIBRARY_H
#define META_OCEAN_MEDIA_OPEN_IMAGE_LIBRARIES_OL_LIBRARY_H
 ...
 * @ingroup mediaoil
 */
class OCEAN_MEDIA_OIL_EXPORT OILLibrary : public Library
{
	friend class Media::Manager;
	friend class OILBufferImage;
	friend class OILImage;
	friend class OILImageSequence;
	...
	protected:
		...
		/**
		 * Creates a new OILLibrary object.
		 */
		OILLibrary();

		/**
		 * Destructs an OILLibrary object.
		 */
		~OILLibrary() override;
...
#endif // META_OCEAN_MEDIA_OPEN_IMAGE_LIBRARIES_OL_LIBRARY_H
