...
#ifndef META_OCEAN_MEDIA_QUEST_PLUGIN_H
#define META_OCEAN_MEDIA_QUEST_PLUGIN_H
 ...
 * @ingroup mediaquest
 */
extern "C" bool OCEAN_MEDIA_QUEST_EXPORT pluginLoad();
 ...
 * @ingroup mediaquest
 */
extern "C" bool OCEAN_MEDIA_QUEST_EXPORT pluginUnload();

#endif // defined(OCEAN_RUNTIME_SHARED)

#endif // META_OCEAN_MEDIA_QUEST_PLUGIN_H
