...
#ifndef META_OCEAN_RENDERING_GI_TRACING_BOX_H
#define META_OCEAN_RENDERING_GI_TRACING_BOX_H
 ...
 * @ingroup renderinggi
 */
class OCEAN_RENDERING_GI_EXPORT TracingBox : public TracingObject
{
	public:
		...
		/**
		 * Sets the main characteristics of the box by providing the object-world transformation and the box's dimension.
		 * @param objectTransformation The transformation transforming points located in the coordinate system of the box to points located in the world coordinate system, must be valid
		 * @param localBoundingBox The bounding box object defining the dimension of the box, must be valid
		 */
...
#endif // META_OCEAN_RENDERING_GI_TRACING_BOX_H
