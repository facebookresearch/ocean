...
#ifndef META_OCEAN_RENDERING_GLES_APPLE_GLES_ENGINE_APPLE_H
#define META_OCEAN_RENDERING_GLES_APPLE_GLES_ENGINE_APPLE_H
 ...
 */
class OCEAN_RENDERING_GLES_EXPORT GLESEngineApple : public GLESEngine
{
	public:
	...
	protected:
		 ...
		 */
		GLESEngineApple(const GraphicAPI graphicAPI);

		/**
		 * Destructs a rendering engine.
		 */
		~GLESEngineApple() override = default;
...
#endif // META_OCEAN_RENDERING_GLES_APPLE_GLES_ENGINE_APPLE_H
