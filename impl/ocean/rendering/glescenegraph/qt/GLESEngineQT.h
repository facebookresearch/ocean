...
#ifndef META_OCEAN_RENDERING_GLES_QT_GLES_ENGINE_QT_H
#define META_OCEAN_RENDERING_GLES_QT_GLES_ENGINE_QT_H
 ...
 */
class OCEAN_RENDERING_GLES_EXPORT GLESEngineQT : public GLESEngine
{
	public:
	...
	protected:
		 ...
		 */
		GLESEngineQT(const GraphicAPI graphicAPI);

		/**
		 * Destructs a rendering engine.
		 */
		~GLESEngineQT() override = default;
...
#endif // META_OCEAN_RENDERING_GLES_QT_GLES_ENGINE_QT_H
