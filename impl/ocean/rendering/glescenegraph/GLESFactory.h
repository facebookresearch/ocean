...
#ifndef META_OCEAN_RENDERING_GLES_FACTORY_H
#define META_OCEAN_RENDERING_GLES_FACTORY_H
...
/**
 * This class implements a class factory for all GLESceneGraph objects.<br>
 * Only the factory is able to create any GLESceneGraph object.
 * @ingroup renderinggles
 */
class OCEAN_RENDERING_GLES_EXPORT GLESFactory : public Factory
{
	public:
		 ...
		 * @see Factory::createFrameTexture2D().
		 */
		 ...
		 * @see Factory::createStereoAttribute().
		 */
...
#endif // META_OCEAN_RENDERING_GLES_FACTORY_H
