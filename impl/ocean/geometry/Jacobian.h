...
class OCEAN_GEOMETRY_EXPORT Jacobian
{
	public:
		 ...
		 */
		static void calculateSphericalObjectPointJacobian3x3(Scalar* jx, Scalar* jy, Scalar* jz, const ExponentialMap& sphericalObjectPoint, const Scalar objectPointDistance);
