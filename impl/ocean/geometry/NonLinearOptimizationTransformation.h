...
class OCEAN_GEOMETRY_EXPORT NonLinearOptimizationTransformation : protected NonLinearOptimization
{
	protected:
		...
		/**
		 * Forward declaration of a class implementing a provider allowing to optimize a 6-DOF transformation for a pinhole camera.
		 */
		class ObjectTransformationPinholeCameraOptimizationProvider;

		/**
		 * Forward declaration of a class implementing a provider allowing to optimize a 6-DOF transformation for a fisheye camera.
		 */
		class AdvancedObjectTransformationFisheyeCameraOptimizationProvider;

		/**
		 * Forward declaration of a class implementing a provider allowing to optimize a 6-DOF transformation for a stereo fisheye camera.
		 */
		class AdvancedObjectTransformationStereoFisheyeCameraOptimizationProvider;
	...
	public:
		...
		/**
		 * Deprecated.
		 * Minimizes the projection error for several 3D object points projected into several pinhole camera images via a 6-DOF object transformation (to be optimized).
		 ...
		 * </pre>
		 * @param pinholeCamera The camera object defining the projection between 3D object points and 2D image points
		 ...
		 * @param objectPoints 3D object points to be projected into the camera image, one 3D object point for each 2D image point visible in each camera frame, at least 3
		 ...
		 * @see optimizeObjectTransformationIF().
		 */
		static inline bool optimizeObjectTransformation(const PinholeCamera& pinholeCamera, const HomogenousMatrices4& world_T_cameras, const HomogenousMatrix4& world_T_object, const Vectors3& objectPoints, const ImagePointGroups& imagePointGroups, HomogenousMatrix4& optimized_world_T_object, const unsigned int iterations = 20u, const Estimator::EstimatorType estimator = Estimator::ET_SQUARE, Scalar lambda = Scalar(0.001), const Scalar lambdaFactor = Scalar(5), Scalar* initialError = nullptr, Scalar* finalError = nullptr, Scalars* intermediateErrors = nullptr);
		 ...
		 * The individual camera poses and the camera profile will not be adjusted.<br>
		 * @param fisheyeCamera Fisheye camera object defining the projection between 3D object points and 2D image points, must be valid
		 * @param world_T_cameras Several 6-DOF camera pose which will not be adjusted, transforming points from the world coordinate system to points in the camera coordinate systems, (world_T_camera), one pose for each group of 2D image points
		 * @param world_T_object The 6-DOF object transformation to be optimized, with orthonormal rotation matrix, must be valid
		 ...
		 */
		static inline bool optimizeObjectTransformation(const FisheyeCamera& fisheyeCamera, const HomogenousMatrices4& world_T_cameras, const HomogenousMatrix4& world_T_object, const ObjectPointGroups& objectPointGroups, const ImagePointGroups& imagePointGroups, HomogenousMatrix4& optimized_world_T_object, const unsigned int iterations = 20u, const Estimator::EstimatorType estimator = Estimator::ET_SQUARE, Scalar lambda = Scalar(0.001), const Scalar lambdaFactor = Scalar(5), Scalar* initialError = nullptr, Scalar* finalError = nullptr, Scalars* intermediateErrors = nullptr);
		 ...
		 */
		static bool optimizeObjectTransformationIF(const FisheyeCamera& fisheyeCamera, const HomogenousMatrices4& flippedCameras_T_world, const HomogenousMatrix4& world_T_object, const ObjectPointGroups& objectPointGroups, const ImagePointGroups& imagePointGroups, HomogenousMatrix4& optimized_world_T_object, const unsigned int iterations = 20u, const Estimator::EstimatorType estimator = Estimator::ET_SQUARE, Scalar lambda = Scalar(0.001), const Scalar lambdaFactor = Scalar(5), Scalar* initialError = nullptr, Scalar* finalError = nullptr, Scalars* intermediateErrors = nullptr);
		 ...
		 * The individual camera poses and the camera profile will not be adjusted.<br>
		 * @param fisheyeCameraA First fisheye camera profile defining the project for the first stereo camera, must be valid
		 * @param fisheyeCameraB Second fisheye camera object defining the project for the second stereo camera, must be valid
		 ...
		 */
		static inline bool optimizeObjectTransformationStereo(const FisheyeCamera& fisheyeCameraA, const FisheyeCamera& fisheyeCameraB, const HomogenousMatrices4& world_T_camerasA, const HomogenousMatrices4& world_T_camerasB, const HomogenousMatrix4& world_T_object, const ObjectPointGroups& objectPointGroupsA, const ObjectPointGroups& objectPointGroupsB, const ImagePointGroups& imagePointGroupsA, const ImagePointGroups& imagePointGroupsB, HomogenousMatrix4& optimized_world_T_object, const unsigned int iterations = 20u, const Estimator::EstimatorType estimator = Estimator::ET_SQUARE, Scalar lambda = Scalar(0.001), const Scalar lambdaFactor = Scalar(5), Scalar* initialError = nullptr, Scalar* finalError = nullptr, Scalars* intermediateErrors = nullptr);
		 ...
		 * @see optimizeObjectTransformation().
		 */
		static bool optimizeObjectTransformationStereoIF(const FisheyeCamera& fisheyeCameraA, const FisheyeCamera& fisheyeCameraB, const HomogenousMatrices4& flippedCamerasA_T_world, const HomogenousMatrices4& flippedCamerasB_T_world, const HomogenousMatrix4& world_T_object, const ObjectPointGroups& objectPointGroupsA, const ObjectPointGroups& objectPointGroupsB, const ImagePointGroups& imagePointGroupsA, const ImagePointGroups& imagePointGroupsB, HomogenousMatrix4& optimized_world_T_object, const unsigned int iterations = 20u, const Estimator::EstimatorType estimator = Estimator::ET_SQUARE, Scalar lambda = Scalar(0.001), const Scalar lambdaFactor = Scalar(5), Scalar* initialError = nullptr, Scalar* finalError = nullptr, Scalars* intermediateErrors = nullptr);
...
inline bool NonLinearOptimizationTransformation::optimizeObjectTransformation(const PinholeCamera& pinholeCamera, const HomogenousMatrices4& world_T_cameras, const HomogenousMatrix4& world_T_object, const Vectors3& objectPoints, const ImagePointGroups& imagePointGroups, HomogenousMatrix4& optimized_world_T_object, const unsigned int iterations, const Estimator::EstimatorType estimator, Scalar lambda, const Scalar lambdaFactor, Scalar* initialError, Scalar* finalError, Scalars* intermediateErrors)
{
	return optimizeObjectTransformationIF(pinholeCamera, PinholeCamera::standard2InvertedFlipped(world_T_cameras), world_T_object, objectPoints, imagePointGroups, optimized_world_T_object, iterations, estimator, lambda, lambdaFactor, initialError, finalError, intermediateErrors);
}

inline bool NonLinearOptimizationTransformation::optimizeObjectTransformation(const FisheyeCamera& fisheyeCamera, const HomogenousMatrices4& world_T_cameras, const HomogenousMatrix4& world_T_object, const ObjectPointGroups& objectPointGroups, const ImagePointGroups& imagePointGroups, HomogenousMatrix4& optimized_world_T_object, const unsigned int iterations, const Estimator::EstimatorType estimator, Scalar lambda, const Scalar lambdaFactor, Scalar* initialError, Scalar* finalError, Scalars* intermediateErrors)
{
	return optimizeObjectTransformationIF(fisheyeCamera, PinholeCamera::standard2InvertedFlipped(world_T_cameras), world_T_object, objectPointGroups, imagePointGroups, optimized_world_T_object, iterations, estimator, lambda, lambdaFactor, initialError, finalError, intermediateErrors);
}

inline bool NonLinearOptimizationTransformation::optimizeObjectTransformationStereo(const FisheyeCamera& fisheyeCameraA, const FisheyeCamera& fisheyeCameraB, const HomogenousMatrices4& world_T_camerasA, const HomogenousMatrices4& world_T_camerasB, const HomogenousMatrix4& world_T_object, const ObjectPointGroups& objectPointGroupsA, const ObjectPointGroups& objectPointGroupsB, const ImagePointGroups& imagePointGroupsA, const ImagePointGroups& imagePointGroupsB, HomogenousMatrix4& optimized_world_T_object, const unsigned int iterations, const Estimator::EstimatorType estimator, Scalar lambda, const Scalar lambdaFactor, Scalar* initialError, Scalar* finalError, Scalars* intermediateErrors)
{
	return optimizeObjectTransformationStereoIF(fisheyeCameraA, fisheyeCameraB, PinholeCamera::standard2InvertedFlipped(world_T_camerasA), PinholeCamera::standard2InvertedFlipped(world_T_camerasB), world_T_object, objectPointGroupsA, objectPointGroupsB, imagePointGroupsA, imagePointGroupsB, optimized_world_T_object, iterations, estimator, lambda, lambdaFactor, initialError, finalError, intermediateErrors);
}
