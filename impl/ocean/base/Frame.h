...
class OCEAN_BASE_EXPORT FrameType
{
	...
	public:
		...
		enum PixelFormat : uint64_t
		{
			...
			/**
			 * This pixel format is deprecated and is currently an alias for FORMAT_YUV24_LIMITED_RANGE.
			 ...
			 *   Color:  YYYYYYYYUUUUUUUUVVVVVVVV YYYYYYYYUUUUUUUUVVVVVVVV YYYYYYYY ........
			 * </pre>
			 * @see FORMAT_YUV24_FULL_RANGE.
			 */
			FORMAT_YUV24_LIMITED_RANGE = FORMAT_YUV24,
			 ...
			 *   Color:  YYYYYYYYUUUUUUUUVVVVVVVV YYYYYYYYUUUUUUUUVVVVVVVV YYYYYYYY ........
			 * </pre>
			 * @see FORMAT_YUV24_LIMITED_RANGE.
			 */
