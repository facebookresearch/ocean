...
// The OCEAN_ALIGN_DATA macro allows to force the alignment of data to a specified byte boundary
	...
	#error You cannot define both flags (DEBUG and NDEBUG) concurrently, find more details here https://fb.me/debug_vs_ndebug.
#endif

#if defined(OCEAN_INTENSIVE_DEBUG) && (!defined(DEBUG) || !defined(OCEAN_DEBUG))
	#error You cannot define OCEAN_INTENSIVE_DEBUG without defining DEBUG/OCEAN_DEBUG, find more details here https://fb.me/debug_vs_ndebug.
#endif
