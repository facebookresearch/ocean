...
class OCEAN_SYSTEM_USB_ANDROID_EXPORT OceanUSBManager : public Singleton<OceanUSBManager>
{
	...
	protected:
		 ...
		 */
		using PermissionCallbackMap = std::unordered_map<std::string, PermissionCallback>;
	...
	public:
		 ...
		 * @return True, if succeeded
		 */
		bool requestPermission(JNIEnv* jniEnv, const std::string& deviceName, PermissionCallback permissionCallback = nullptr);
