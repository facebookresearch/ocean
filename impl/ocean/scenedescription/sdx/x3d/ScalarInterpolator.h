...
#ifndef META_OCEAN_SCENEDESCRIPTION_SDX_X3D_SCALAR_INTERPOLATOR_H
#define META_OCEAN_SCENEDESCRIPTION_SDX_X3D_SCALAR_INTERPOLATOR_H
 ...
 */
class OCEAN_SCENEDESCRIPTION_SDX_X3D_EXPORT ScalarInterpolator : virtual public X3DInterpolatorNode
{
	public:
		 ...
		 */
		explicit ScalarInterpolator(const SDXEnvironment* environment);
...
#endif // META_OCEAN_SCENEDESCRIPTION_SDX_X3D_SCALAR_INTERPOLATOR_H
