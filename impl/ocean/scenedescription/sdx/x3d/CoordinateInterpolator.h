...
#ifndef META_OCEAN_SCENEDESCRIPTION_SDX_X3D_COORDINATE_INTERPOLATOR_H
#define META_OCEAN_SCENEDESCRIPTION_SDX_X3D_COORDINATE_INTERPOLATOR_H
 ...
 */
class OCEAN_SCENEDESCRIPTION_SDX_X3D_EXPORT CoordinateInterpolator : virtual public X3DInterpolatorNode
{
	public:
		 ...
		 */
		explicit CoordinateInterpolator(const SDXEnvironment* environment);
...
#endif // META_OCEAN_SCENEDESCRIPTION_SDX_X3D_COORDINATE_INTERPOLATOR_H
