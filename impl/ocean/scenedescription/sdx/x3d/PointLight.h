...
#ifndef META_OCEAN_SCENEDESCRIPTION_SDX_X3D_POINT_LIGHT_H
#define META_OCEAN_SCENEDESCRIPTION_SDX_X3D_POINT_LIGHT_H
...
/**
 * This class implements a x3d point light node.
 * @ingroup scenedescriptionsdxx3d
 */
class OCEAN_SCENEDESCRIPTION_SDX_X3D_EXPORT PointLight : virtual public X3DLightNode
{
	public:

		/**
		 * Creates a new x3d point light node.
		 * @param environment Node environment
		 */
		explicit PointLight(const SDXEnvironment* environment);
...
#endif // META_OCEAN_SCENEDESCRIPTION_SDX_X3D_POINT_LIGHT_H
