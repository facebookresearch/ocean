...
/**
 * The OpenGLFrameMediumViewController implements a view controller that is mainly able to display medium objects.
 ...
 */
@interface OpenGLFrameMediumViewController : OpenGLRendererViewController
