...
bool Utilities::manifestVersion(JavaVM* javaVM, jobject activity, int& versionCode, std::string& versionName)
{
	...
	const ScopedJObject packageInfo(scopedJNIEnvironment, scopedJNIEnvironment.jniEnv()->CallObjectMethod(packageManager, getPackageInfoMethodId, packageName.object(), 0x0));
...
bool Utilities::manifestSdkVersions(JNIEnv* env, jobject activity, unsigned int& minSdkVersion, unsigned int& targetSdkVersion)
{
	...
	const ScopedJObject jApplicationInfoObject(*env, env->CallObjectMethod(jPackageManagerObject, jGetApplicationInfoMethodId, jPackageNameString.object(), 0x0));
...
bool Utilities::sendIntentToComponent(JNIEnv* env, jobject activity, const std::string &packageName, const std::string &className, const std::string &extraText)
{
	...
	const ScopedJObject jComponentNameObject(*env, env->NewObject(jComponentNameClass, jNewComponentNameMethod, jPackageName.object(), jClassName.object()));
	...
	jstring jActionSendValue = (jstring)(env->GetStaticObjectField(jIntentClass.object(), jActionSendField));
	jstring jExtraTextValue = (jstring)(env->GetStaticObjectField(jIntentClass.object(), jExtraTextField));

	jmethodID jNewIntentMethod = env->GetMethodID(jIntentClass.object(), "<init>", "(Ljava/lang/String;)V");
	jmethodID jPutExtraMethod = env->GetMethodID(jIntentClass.object(), "putExtra", "(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;");
	jmethodID jSetTypeMethod = env->GetMethodID(jIntentClass.object(), "setType", "(Ljava/lang/String;)Landroid/content/Intent;");
	jmethodID jSetComponentNameMethod = env->GetMethodID(jIntentClass.object(), "setComponent","(Landroid/content/ComponentName;)Landroid/content/Intent;");
	...
	ScopedJObject jIntentObject(*env, env->NewObject(jIntentClass.object(), jNewIntentMethod, jActionSendValue));
	...
	env->CallObjectMethod(jIntentObject.object(), jPutExtraMethod, jExtraTextValue, jExtraText.object());

	const ScopedJString jMimeType(*env, env->NewStringUTF("text/plain"));
	env->CallObjectMethod(jIntentObject.object(), jSetTypeMethod, jMimeType.object());

	env->CallObjectMethod(jIntentObject.object(), jSetComponentNameMethod, jComponentNameObject.object());

	jmethodID jStartActivityMethod = env->GetMethodID(jActivityClass.object(), "startActivity", "(Landroid/content/Intent;)V");
	...
	env->CallVoidMethod(activity, jStartActivityMethod, jIntentObject.object());
...
bool Utilities::startActivity(JNIEnv* env, jobject rootActivity, const std::string& activityClassName)
{
	...
	jmethodID jStartActivityMethod = env->GetMethodID(jRootActivityClass.object(), "startActivity", "(Landroid/content/Intent;)V");
	...
	jmethodID jNewIntentMethod = env->GetMethodID(jIntentClass.object(), "<init>", "(Landroid/content/Context;Ljava/lang/Class;)V");
	...
	ScopedJObject jIntentObject(*env, env->NewObject(jIntentClass.object(), jNewIntentMethod, rootActivity, jActivityClass.object()));
	...
	env->CallVoidMethod(rootActivity, jStartActivityMethod, jIntentObject.object());
...
bool Utilities::connectToWifi(JNIEnv* env, jobject activity, const std::string& ssid, const std::string& password)
{
	...
	env->SetObjectField(jWifiConfigurationObject.object(), jSsidField, jSsidString.object());
	env->SetObjectField(jWifiConfigurationObject.object(), jPreSharedKeyField, jPasswordString.object());
	env->SetIntField(jWifiConfigurationObject.object(), jStatus, jEnabled);
	...
	const ScopedJObject jWifiManagerObject(*env, env->CallObjectMethod(activity, jGetSystemServiceMethod, jWifiServiceString.object()));
	...
	jint newNetworkID = env->CallIntMethod(jWifiManagerObject, jAddNetworkMethod, jWifiConfigurationObject.object());
...
bool Utilities::sendIntentToConnectToWifi(JNIEnv* env, jobject activity, const std::string& ssid, const std::string& password)
{
	...
	jBuilderObject = ScopedJObject(*env, env->CallObjectMethod(jBuilderObject, jSetSsidMethod, jSsidString.object()));
	...
	jBuilderObject = ScopedJObject(*env, env->CallObjectMethod(jBuilderObject, jSetWpa2PassphraseMethod, jPasswordString.object()));
	...
	jmethodID jnewArrayListMethod = env->GetMethodID(jArrayListClass.object(), "<init>", "()V");
	...
	if (!env->CallBooleanMethod(jArrayListObject.object(), jAddMethod, jWifiNetworkSuggestionObject.object()))
	{
		return false;
	}
	...
	env->CallVoidMethod(jBundleObject, jPutParcelableArrayListMethod, jExtraWifiNetworkListString.object(), jArrayListObject.object());
	...
	ScopedJObject jIntentObject(*env, env->NewObject(jIntentClass, jNewIntentMethod, jActionWifiAddNetworksString.object()));
	...
	jIntentObject = ScopedJObject(*env, env->CallObjectMethod(jIntentObject.object(), jPutExtrasMethod, jBundleObject.object()));
	...
	env->CallVoidMethod(activity, jStartActivityForResultMethod, jIntentObject.object(), jint(0));
...
bool Utilities::currentWifiSsid(JNIEnv* env, jobject activity, std::string& ssid)
{
	...
	const ScopedJObject jConnectivityManagerObject(*env, env->CallObjectMethod(activity, jGetSystemServiceMethodId, jConnectivityServiceString.object()));
	...
	if (!env->CallBooleanMethod(jNetworkInfoObject.object(), jIsConnectedMethodId))
	{
		// No active network connection
		ssid = "";
		return true;
	...
	const ScopedJObject jWifiManagerObject(*env, env->CallObjectMethod(activity, jGetSystemServiceMethodId, jWifiServiceString.object()));
	...
	const ScopedJObject jWifiInfoObject(*env, env->CallObjectMethod(jWifiManagerObject, jGetConnectionInfoMethodId, jWifiServiceString.object()));
