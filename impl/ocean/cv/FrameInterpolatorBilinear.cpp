...
void FrameInterpolatorBilinear::SpecialCases::resize400x400To224x224_8BitPerChannel(const uint8_t* const source, uint8_t* const target, const unsigned int sourcePaddingElements, const unsigned int targetPaddingElements)
{
	...
	const uint8x16_t shuffleA_u_8x16 = NEON::create_uint8x16(0u, 1u, 2u, 3u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 12u, 13u); // [ 0L 0R 1L 1R ...
	const uint8x16_t shuffleB_u_8x16 = NEON::create_uint8x16(5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 12u, 13u, 14u, 15u, 255u, 255u, 255u, 255u); // [ 8L 8R 9L 9R ... 13L 13R X X X X ]
	...
	const uint8x8_t factorsLeftRightA_u_8x8 = NEON::create_uint8x8(78u, 50u, 105u, 23u, 5u, 123u, 32u, 96u);
	const uint8x8_t factorsLeftRightB_u_8x8 = NEON::create_uint8x8(59u, 69u, 87u, 41u, 114u, 14u, 14u, 114u);
	const uint8x8_t factorsLeftRightC_u_8x8 = NEON::create_uint8x8(41u, 87u, 69u, 59u, 96u, 32u, 123u, 5u);
	const uint8x8_t factorsLeftRightD_u_8x8 = NEON::create_uint8x8(23u, 105u, 50u, 78u, 0u, 0u, 0u, 0u);
...
void FrameInterpolatorBilinear::SpecialCases::resize400x400To256x256_8BitPerChannel(const uint8_t* const source, uint8_t* const target, const unsigned int sourcePaddingElements, const unsigned int targetPaddingElements)
{
	...
	const uint8x16_t shuffleA_u_8x16 = NEON::create_uint8x16(0u, 1u, 1u, 2u, 3u, 4u, 4u, 5u, 6u, 7u, 8u, 9u, 9u, 10u, 11u, 12u); // [ 0L 0R 1L 1R ...
	const uint8x16_t shuffleB_u_8x16 = NEON::create_uint8x16(3u, 4u, 5u, 6u, 6u, 7u, 8u, 9u, 10u, 11u, 11u, 12u, 13u, 14u, 14u, 15u); // [ 8L 8R 9L 9R ...
	...
	const uint8x8_t factorsLeftRightA_u_8x8 = NEON::create_uint8x8(92u, 36u, 20u, 108u, 76u, 52u, 4u, 124u);
	const uint8x8_t factorsLeftRightB_u_8x8 = NEON::create_uint8x8(60u, 68u, 116u, 12u, 44u, 84u, 100u, 28u);
	const uint8x8_t factorsLeftRightC_u_8x8 = NEON::create_uint8x8(28u, 100u, 84u, 44u, 12u, 116u, 68u, 60u);
	const uint8x8_t factorsLeftRightD_u_8x8 = NEON::create_uint8x8(124u, 4u, 52u, 76u, 108u, 20u, 36u, 92u);
...
void FrameInterpolatorBilinear::SpecialCases::resize400x400To256x256_8BitPerChannel(const uint8_t* const source, uint8_t* const target, const unsigned int sourcePaddingElements, const unsigned int targetPaddingElements)
{
	...
	const uint8x16_t shuffleLeftA_u_8x16 = NEON::create_uint8x16(16u, 16u, 16u, 16u, 16u, 0u, 1u, 3u, 4u, 6u, 8u, 9u, 11u, 12u, 14u, 15u);
	const uint8x16_t shuffleLeftB_u_8x16 = NEON::create_uint8x16(8u, 10u, 11u, 13u, 14u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u);

	const uint8x16_t shuffleRightA_u_8x16 = NEON::create_uint8x16(16u, 16u, 16u, 16u, 16u, 16u, 1u, 2u, 4u, 5u, 7u, 9u, 10u, 12u, 13u, 15u);
	const uint8x16_t shuffleRightB_u_8x16 = NEON::create_uint8x16(7u, 9u, 11u, 12u, 14u, 15u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u);
	...
	const uint8x8_t factorsLeftA_u_8x8 = NEON::create_uint8x8(92u, 20u, 76u, 4u, 60u, 116u, 44u, 100u);
	const uint8x8_t factorsLeftB_u_8x8 = NEON::create_uint8x8(28u, 84u, 12u, 68u, 124u, 52u, 108u, 36u);

	const uint8x8_t factorsRightA_u_8x8 = NEON::create_uint8x8(36u, 108u, 52u, 124u, 68u, 12u, 84u, 28u);
	const uint8x8_t factorsRightB_u_8x8 = NEON::create_uint8x8(100u, 44u, 116u, 60u, 4u, 76u, 20u, 92u);
...
inline void FrameInterpolatorBilinear::interpolateRowHorizontal8BitPerChannel7BitPrecisionNEON<2u>(const uint8_t* extendedSourceRow, uint8_t* targetRow, const unsigned int targetWidth, const unsigned int channels, const unsigned int* interpolationLocations, const uint8_t* interpolationFactors)
{
	...
	const uint8x8_t mask_left_8x8 = NEON::create_uint8x8(0, 0, 2, 2, 4, 4, 6, 6);
	const uint8x8_t mask_right_8x8 = NEON::create_uint8x8(1, 1, 3, 3, 5, 5, 7, 7);
...
inline void FrameInterpolatorBilinear::interpolateRowHorizontal8BitPerChannel7BitPrecisionNEON<4u>(const uint8_t* extendedSourceRow, uint8_t* targetRow, const unsigned int targetWidth, const unsigned int channels, const unsigned int* interpolationLocations, const uint8_t* interpolationFactors)
{
	...
	const uint8x8_t mask_02_8x8 = NEON::create_uint8x8(0, 0, 0, 0, 2, 2, 2, 2);
	const uint8x8_t mask_13_8x8 = NEON::create_uint8x8(1, 1, 1, 1, 3, 3, 3, 3);
	const uint8x8_t mask_46_8x8 = NEON::create_uint8x8(4, 4, 4, 4, 6, 6, 6, 6);
	const uint8x8_t mask_57_8x8 = NEON::create_uint8x8(5, 5, 5, 5, 7, 7, 7, 7);
