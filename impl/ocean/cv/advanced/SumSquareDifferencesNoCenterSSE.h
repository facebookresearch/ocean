...
#ifndef META_OCEAN_CV_ADVANCED_SUM_SQUARE_DIFFERENCES_NO_CENTER_SSE_H
#define META_OCEAN_CV_ADVANCED_SUM_SQUARE_DIFFERENCES_NO_CENTER_SSE_H
...
/**
 * This class implements functions calculating the sum of square differences and omits center pixel using SSE instructions.
 * @ingroup cvadvanced
 */
class SumSquareDifferencesNoCenterSSE
{
	protected:
		 ...
		 */
		class SumSquareDifferencesSSE : public CV::SumSquareDifferencesSSE
		{
			// nothing to do here
		};
...
#endif // META_OCEAN_CV_ADVANCED_SUM_SQUARE_DIFFERENCES_NO_CENTER_SSE_H
