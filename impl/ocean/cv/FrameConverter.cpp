...
FrameConverter::ConversionFunctionMap::ConversionFunctionMap()
{
	...
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_BGR24, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterBGR24::convertBGR24ToY8FullRange);
	...
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_BGRA32, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterBGRA32::convertBGRA32ToY8FullRange);
	...
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y8_FULL_RANGE, FrameType::FORMAT_RGB24), FrameConverterY8::convertY8FullRangeToRGB24);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y8_FULL_RANGE, FrameType::FORMAT_RGBA32, Options::OT_ALPHA_CHANNEL_TARGET_VALUE), FrameConverterY8::convertY8FullRangeToRGBA32);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y8_FULL_RANGE, FrameType::FORMAT_Y8_FULL_RANGE, Options::OT_GAMMA_CORRECTION), FrameConverterY8::convertY8ToY8GammaLUT);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y8_FULL_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE), FrameConverterY8::convertY8FullRangeToY8LimitedRange<6u /*tPrecision*/>);

	// FORMAT_Y8_LIMITED_RANGE
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y8_LIMITED_RANGE, FrameType::FORMAT_RGB24), FrameConverterY8::convertY8LimitedRangeToRGB24<6u /*tPrecision*/>);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y8_LIMITED_RANGE, FrameType::FORMAT_RGBA32, Options::OT_ALPHA_CHANNEL_TARGET_VALUE), FrameConverterY8::convertY8LimitedRangeToRGBA32<6u /*tPrecision*/>);
	...
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_U_V12_LIMITED_RANGE, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterY_U_V12::convertY_U_V12LimitedRangeToY8FullRange);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_U_V12_LIMITED_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE), FrameConverterY_U_V12::convertY_U_V12LimitedRangeToY8LimitedRange);
	...
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_U_V12_FULL_RANGE, FrameType::FORMAT_Y_U_V12_FULL_RANGE), FrameConverterY_U_V12::convertY_U_V12ToY_U_V12);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_U_V12_FULL_RANGE, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterY_U_V12::convertY_U_V12FullRangeToY8FullRange);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_U_V12_FULL_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE), FrameConverterY_U_V12::convertY_U_V12FullRangeToY8LimitedRange);
	...
	// FORMAT_YUV24 (aka FORMAT_YUV24_LIMITED_RANGE)
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_YUV24_LIMITED_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE), FrameConverterYUV24::convertYUV24LimitedRangeToY8LimitedRange);
	...
	// FORMAT_YUV24_FULL_RANGE
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_YUV24_FULL_RANGE, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterYUV24::convertYUV24FullRangeToY8FullRange);
	...
	// FORMAT_YVU24 (aka FORMAT_YVU24_LIMITED_RANGE)
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_YVU24_LIMITED_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE), FrameConverterYVU24::convertYVU24LimitedRangeToY8LimitedRange);
	...
	// FORMAT_YVU24_FULL_RANGE
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_YVU24_FULL_RANGE, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterYVU24::convertYVU24FullRangeToY8FullRange);
	...
	// FORMAT_Y_V_U12_LIMITED_RANGE (alias is FORMAT_Y_V_U12)
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_V_U12_LIMITED_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE), FrameConverterY_V_U12::convertY_V_U12LimitedRangeToY8LimitedRange);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_V_U12_LIMITED_RANGE, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterY_V_U12::convertY_V_U12LimitedRangeToY8FullRange);
	...
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_V_U12_FULL_RANGE, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterY_V_U12::convertY_V_U12FullRangeToY8FullRange);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_V_U12_FULL_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE), FrameConverterY_V_U12::convertY_V_U12FullRangeToY8LimitedRange);
	...
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_VU12_LIMITED_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE), FrameConverterY_VU12::convertY_VU12LimitedRangeToY8LimitedRange);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_VU12_LIMITED_RANGE, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterY_VU12::convertY_VU12LimitedRangeToY8FullRange);
	...
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_VU12_LIMITED_RANGE, FrameType::FORMAT_Y_UV12_LIMITED_RANGE), FrameConverterY_VU12::convertY_VU12ToY_UV12);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_VU12_LIMITED_RANGE, FrameType::FORMAT_Y_U_V12_LIMITED_RANGE), FrameConverterY_VU12::convertY_VU12ToY_U_V12);

	// FORMAT_Y_VU12_FULL_RANGE
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_VU12_FULL_RANGE, FrameType::FORMAT_Y8_FULL_RANGE), FrameConverterY_VU12::convertY_VU12FullRangeToY8FullRange);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_VU12_FULL_RANGE, FrameType::FORMAT_Y8_LIMITED_RANGE), FrameConverterY_VU12::convertY_VU12FullRangeToY8LimitedRange);
	...
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_VU12_FULL_RANGE, FrameType::FORMAT_Y_UV12_FULL_RANGE), FrameConverterY_VU12::convertY_VU12ToY_UV12);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_VU12_FULL_RANGE, FrameType::FORMAT_Y_U_V12_FULL_RANGE), FrameConverterY_VU12::convertY_VU12ToY_U_V12);
	formatPair2FunctionWrapperMap_.emplace(ConversionTriple(FrameType::FORMAT_Y_VU12_FULL_RANGE, FrameType::FORMAT_BGRA32, Options::OT_ALPHA_CHANNEL_TARGET_VALUE), FrameConverterY_VU12::convertY_VU12FullRangeToBGRA32FullRangeAndroid);
...
void FrameConverter::convertOneRow_1Plane1Channel_To_1Plane1Channel_8BitPerChannel_Precision6Bit(const void** sources, void** targets, const unsigned int multipleRowIndex, const unsigned int width, const unsigned int height, const ConversionFlag conversionFlag, const void* options)
{
	ocean_assert(sources != nullptr && targets != nullptr);
	ocean_assert(width >= 1u && height >= 1u);
	...
	// with transformation:
	// t = clamp(0, ((s - biasInput) * factor) / 64 + biasOutput, 255)
	...
	const __m128i biasInput_u_16x8 = _mm_set1_epi16(int16_t(biasInput));
	...
	for (unsigned int n = 0u; n < blocks; ++n)
	{
		const __m128i source_u_8x16 = _mm_lddqu_si128((const __m128i*)source);

		// source - biasInput (extend uint8 to int16 and subtract)
		const __m128i source_low_s_16x8 = _mm_subs_epi16(_mm_unpacklo_epi8(source_u_8x16, _mm_setzero_si128()), biasInput_u_16x8);
		const __m128i source_high_s_16x8 = _mm_subs_epi16(_mm_unpackhi_epi8(source_u_8x16, _mm_setzero_si128()), biasInput_u_16x8);

		// multiply by factor
		__m128i result_low_s_16x8 = _mm_mullo_epi16(source_low_s_16x8, factor_s_16x8);
		__m128i result_high_s_16x8 = _mm_mullo_epi16(source_high_s_16x8, factor_s_16x8);

		// divide by 64 (arithmetic shift right by 6 with rounding)
		result_low_s_16x8 = _mm_srai_epi16(_mm_adds_epi16(result_low_s_16x8, _mm_set1_epi16(32)), 6);
		result_high_s_16x8 = _mm_srai_epi16(_mm_adds_epi16(result_high_s_16x8, _mm_set1_epi16(32)), 6);

		// add biasOutput
		result_low_s_16x8 = _mm_adds_epi16(result_low_s_16x8, biasOutput_s_16x8);
		result_high_s_16x8 = _mm_adds_epi16(result_high_s_16x8, biasOutput_s_16x8);

		// saturated pack signed int16 to unsigned uint8
		const __m128i result_u_8x16 = _mm_packus_epi16(result_low_s_16x8, result_high_s_16x8);
	...
	while (source != sourceEnd)
	{
		...
		*target = (uint8_t)(minmax<int16_t>(0, (adjustedSource * int16_t(factor)) / 64 + int16_t(biasOutput), 255));
	...
	if (mirrorTarget)
	{
		CV::FrameChannels::reverseRowPixelOrderInPlace<uint8_t, 1u>(target - width, width);
	}
}

void FrameConverter::convertOneRow_1Plane1Channel_To_1Plane1Channel_8BitPerChannel_Precision10Bit(const void** sources, void** targets, const unsigned int multipleRowIndex, const unsigned int width, const unsigned int height, const ConversionFlag conversionFlag, const void* options)
{
	ocean_assert(sources != nullptr && targets != nullptr);
	ocean_assert(width >= 1u && height >= 1u);
	...
	// with transformation:
	// t = clamp(0, ((s - biasInput) * factor) / 1024 + biasOutput, 255)
	...
	const __m128i factor_s_16x8 = _mm_set1_epi16(int16_t(factor));
	const __m128i biasOutput_1024_s_32x4 = _mm_set1_epi32(int32_t(biasOutput) * 1024);
	const __m128i biasInputAdjustment_s_32x4 = _mm_set1_epi32(int32_t(biasInput) * int32_t(factor));
	const __m128i constant_512_s_32x4 = _mm_set1_epi32(512); // for rounding
	...
	for (unsigned int n = 0u; n < blocks; ++n)
	{
		// load 8 uint8 values and extend to int16
		const __m128i source_u_8x8 = _mm_loadl_epi64((const __m128i*)source);
		const __m128i source_s_16x8 = _mm_unpacklo_epi8(source_u_8x8, _mm_setzero_si128());

		// multiply int16 * int16 -> int32 (need both low and high parts)
		const __m128i multiplyLow_s_16x8 = _mm_mullo_epi16(source_s_16x8, factor_s_16x8);
		const __m128i multiplyHigh_s_16x8 = _mm_mulhi_epi16(source_s_16x8, factor_s_16x8);

		// interleave to get full 32-bit results
		__m128i result_low_s_32x4 = _mm_unpacklo_epi16(multiplyLow_s_16x8, multiplyHigh_s_16x8);
		__m128i result_high_s_32x4 = _mm_unpackhi_epi16(multiplyLow_s_16x8, multiplyHigh_s_16x8);

		// add biasOutput * 1024
		result_low_s_32x4 = _mm_add_epi32(result_low_s_32x4, biasOutput_1024_s_32x4);
		result_high_s_32x4 = _mm_add_epi32(result_high_s_32x4, biasOutput_1024_s_32x4);

		// subtract biasInput * factor
		result_low_s_32x4 = _mm_sub_epi32(result_low_s_32x4, biasInputAdjustment_s_32x4);
		result_high_s_32x4 = _mm_sub_epi32(result_high_s_32x4, biasInputAdjustment_s_32x4);

		// divide by 1024 with rounding: (value + 512) >> 10
		result_low_s_32x4 = _mm_srai_epi32(_mm_add_epi32(result_low_s_32x4, constant_512_s_32x4), 10);
		result_high_s_32x4 = _mm_srai_epi32(_mm_add_epi32(result_high_s_32x4, constant_512_s_32x4), 10);

		// pack int32 to int16
		const __m128i result_s_16x8 = _mm_packs_epi32(result_low_s_32x4, result_high_s_32x4);

		// pack int16 to uint8 with saturation
		const __m128i result_u_8x8 = _mm_packus_epi16(result_s_16x8, _mm_setzero_si128());

		_mm_storel_epi64((__m128i*)target, result_u_8x8);
	...
	while (source != sourceEnd)
	{
		...
		const int16_t adjustedSource = int16_t(*source) - int16_t(biasInput);
		*target = (uint8_t)(minmax<int>(0, (adjustedSource * int16_t(factor)) / 1024 + int16_t(biasOutput), 255));
...
void FrameConverter::convertOneRow_1Plane1Channel_To_1Plane3Channels_8BitPerChannel_Precision10Bit(const void** sources, void** targets, const unsigned int multipleRowIndex, const unsigned int width, const unsigned int height, const ConversionFlag conversionFlag, const void* options)
{
	...
	for (unsigned int n = 0u; n < blocks; ++n)
	{
		...
		// multiply by factor (16-bit x 16-bit -> 32-bit)
		const __m128i source_factor_low_s_16x8 = _mm_mullo_epi16(source_u_16x8, factor_s_16x8);
		const __m128i source_factor_high_s_16x8 = _mm_mulhi_epu16(source_u_16x8, factor_s_16x8);

		// interleave low and high parts to form 32-bit results
		__m128i result_low_s_32x4 = _mm_unpacklo_epi16(source_factor_low_s_16x8, source_factor_high_s_16x8);
		__m128i result_high_s_32x4 = _mm_unpackhi_epi16(source_factor_low_s_16x8, source_factor_high_s_16x8);
