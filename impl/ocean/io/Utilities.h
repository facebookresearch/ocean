...
class OCEAN_IO_EXPORT Utilities
{
	...
	public:
		...
		/**
		 * Encodes a 4x4 homogenous matrix.
		 * The matrix will be stored with 64 bit precision.
		 * @param matrix The homogenous matrix which will be encoded
		...
		/**
		 * Decodes a 4x4 homogenous matrix.
		 ...
		 */
		static bool decodeHomogenousMatrix4(const unsigned char*& data, size_t& size, HomogenousMatrix4& matrix);
		 ...
		 * @return True, if succeeded
		 */
		static bool decodeVectors2(const unsigned char*& data, size_t& size, Vectors2& vectors);
		 ...
		 * @return True, if succeeded
		 */
		static bool decodeVectors3(const unsigned char*& data, size_t& size, Vectors3& vectors);
		 ...
		 * The vectors will be stored with 64 bit precision.
		 * @param vectors The vectors to encode
		 * @param size The number of given vectrs
		 * @param buffer The resulting buffer which will be extended so that already existing data stays untouched
		 */
		 ...
		 * @return True, if succeeded
		 */
		static bool decodeVectors4(const unsigned char*& data, size_t& size, Vectors4& vectors);
