...
#ifndef FACEBOOK_APPLICATION_OCEAN_TEST_MATH_TESTMATH_TEST_MATH_H
#define FACEBOOK_APPLICATION_OCEAN_TEST_MATH_TESTMATH_TEST_MATH_H

#include "application/ocean/test/math/ApplicationTestMath.h"

/**
 * @ingroup applicationtestmath
 * @defgroup applicationtestmathtestmath Math Test
 * @{
...
#endif // FACEBOOK_APPLICATION_OCEAN_TEST_MATH_TESTMATH_TEST_MATH_H
