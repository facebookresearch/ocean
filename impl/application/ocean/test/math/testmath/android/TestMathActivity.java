...
package com.facebook.ocean.app.test.math.testmath.android;
...
/**
 * This class implements the main Activity of the test application of the Math library.
 * @ingroup applicationtestmathtestmathandroid
 */
public class TestMathActivity extends TextActivity
{
	// load the library
	static
	{
		System.loadLibrary("OceanTestMath");
	}
