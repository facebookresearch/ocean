...
package com.facebook.ocean.app.test.unifiedfeatures.testunifiedfeatures.android;
...
/**
 * This class implements the main Activity of the test application of the Unified Features library.
 * @ingroup applicationtestunifiedfeaturestestunifiedfeaturesandroid
 */
public class TestUnifiedFeaturesActivity extends TextActivity
{
	// load the library
	static
	{
		 System.loadLibrary("OceanTestUnifiedFeatures");
	}
