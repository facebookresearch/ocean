...
package com.meta.ocean.app.test.cv.testcv.testdetector.testbullseyes.android;
...
/**
 * This class implements the main Activity of the test application of the Computer Vision Detector Bullseyes library.
 * @ingroup applicationtestcvtestcvdetectorbullseyesandroid
 */
public class TestCVDetectorBullseyesActivity extends TextActivity
{
	// load the library
	static
	{
		System.loadLibrary("OceanTestCVDetectorBullseyes");
	}
