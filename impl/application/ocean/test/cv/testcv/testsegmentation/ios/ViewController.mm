...
- (void)viewDidLoad
{
	...
	const unsigned int testWidth = 640u;
	const unsigned int testHeight = 480u;

	// define the subset of functions which will be invoked, an empty set invokes all functions
	const std::string testFunctions;

	Test::TestCV::TestSegmentation::testCVSegmentationAsynchron(testDurations, testWidth, testHeight, testFunctions);
