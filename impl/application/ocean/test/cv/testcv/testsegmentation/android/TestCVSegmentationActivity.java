...
package com.facebook.ocean.app.test.cv.testcv.testsegmentation.android;
...
/**
 * This class implements the main Activity of the test application of the Computer Vision Segmentation library.
 * @ingroup applicationtestcvtestcvsegmentationandroid
 */
public class TestCVSegmentationActivity extends TextActivity
{
	// load the library
	static
	{
		System.loadLibrary("OceanTestCVSegmentation");
	}
	...
	public void onStart()
	{
		...
		final int testWidth = 640;
		final int testHeight = 480;

		// Define the test duration in seconds.
		final double testDuration = 2.0;

		// Use "" to execute the entire test
		// Use e.g. "maskanalyzer" to execute only the mask analyzer test
		// Use e.g. "maskanalyzer, anothertest" to execute more than one test
