...
#ifndef OCEAN_META_APPLICATION_DEMO_MEDIA_QUESTCAMERA_QUEST_QUEST_CAMERA_APPLICATION_H
#define OCEAN_META_APPLICATION_DEMO_MEDIA_QUESTCAMERA_QUEST_QUEST_CAMERA_APPLICATION_H
 ...
 */
class QuestCameraApplication : public OpenXR::Application::VRNativeApplicationAdvanced
{
	protected:
		...
		enum ApplicationState
		{
			...
			AS_IDLE,
			/// The application need to enumerate Quest cameras.
	...
	public:
		 ...
		 */
		explicit QuestCameraApplication(struct android_app* androidApp);
	...
	protected:
		...
		/**
		 * Enumerates all Quest cameras and dispalys them in a table menu.
		 */
	...
	protected:
		...
		/// The rendering Transform node holding the 3D box with the live texture of the Quest camera.
		...
		/// The table menu allowing to select the Quest camera.
		OpenXR::Application::VRTableMenu vrTableMenu_;

		/// The application's state.
		ApplicationState applicationState_ = AS_IDLE;

		/// The individual stream configurations the Quest camera supports.
...
#endif // OCEAN_META_APPLICATION_DEMO_MEDIA_QUESTCAMERA_QUEST_QUEST_CAMERA_APPLICATION_H
