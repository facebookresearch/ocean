...
#include "application/ocean/demo/cv/binarizationotsu/win/BinarizationOtsu.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		BinarizationOtsuMainWindow mainWindow(hInstance, String::toWString(std::string("Adaptive threshold (") + Build::buildString() + std::string(")")), mediaFile);
