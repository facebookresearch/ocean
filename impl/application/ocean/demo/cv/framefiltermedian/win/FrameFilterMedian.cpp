...
#include "application/ocean/demo/cv/framefiltermedian/win/FrameFilterMedian.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		FrameFilterMedianMainWindow mainWindow(hInstance, String::toWString(std::string("Median Filter Original ") + Build::buildString()), mediaFile);
