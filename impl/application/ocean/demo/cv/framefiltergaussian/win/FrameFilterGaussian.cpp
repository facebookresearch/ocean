...
#include "application/ocean/demo/cv/framefiltergaussian/win/FrameFilterGaussian.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		FrameFilterGaussianMainWindow mainWindow(hInstance, String::toWString(std::string("Frame Filter Gaussian (") + Build::buildString() + std::string(")")), mediaFile);
