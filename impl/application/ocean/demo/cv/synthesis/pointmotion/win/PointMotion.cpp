...
#include "application/ocean/demo/cv/synthesis/pointmotion/win/PointMotion.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		PointMotionMainWindow mainWindow(hInstance, String::toWString(std::string("Motion detection, ") + Build::buildString()), mediaFile);
