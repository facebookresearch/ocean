...
#include "application/ocean/demo/cv/framefiltersobel/win/FrameFilterSobel.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		FrameFilterSobelMainWindow mainWindow(hInstance, String::toWString(std::string("Sobel filter (") + Build::buildString() + std::string(")")), mediaFile);
