...
#include "application/ocean/demo/cv/detector/harriscorner/win/HarrisCorner.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		HarrisCornerMainWindow mainWindow(hInstance, String::toWString(std::string("Harris corner detector (") + Build::buildString() + std::string(")")), mediaFile);
