...
#ifndef FACEBOOK_APPLICATION_OCEAN_DEMO_CV_DETECTOR_LINEDETECTOR_MACOS_APP_DELEGATE_H
#define FACEBOOK_APPLICATION_OCEAN_DEMO_CV_DETECTOR_LINEDETECTOR_MACOS_APP_DELEGATE_H

#import <Cocoa/Cocoa.h>

/**
 * @ingroup applicationdemocvdetectorlinedetector
 * @defgroup applicationdemocvdetectorlinedetectormacos Line Detector (macOS)
 * @{
...
#endif // FACEBOOK_APPLICATION_OCEAN_DEMO_CV_DETECTOR_LINEDETECTOR_MACOS_APP_DELEGATE_H
