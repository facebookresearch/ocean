...
#include "application/ocean/demo/cv/detector/harriscornervotes/win/HarrisCornerVotes.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		HarrisCornerVotesMainWindow mainWindow(hInstance, String::toWString(std::string("Harris corner votes (") + Build::buildString() + std::string(")")), mediaFile);
