...
/**
 * @ingroup applicationdemocvdetectorqrcode
 * @defgroup applicationdemocvdetectorqrcodemacos 3D QR Codes (macOS)
 * @{
 * This application demonstrates the detection and decoding of 3D QR codes from video frames (e.g., from a live video/webcam).
