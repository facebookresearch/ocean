...
#include "application/ocean/demo/cv/detector/fastcornerpyramid/win/FastCornerPyramid.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		FASTCornerPyramidMainWindow mainWindow(hInstance, String::toWString(std::string("FAST corner detector pyramid (") + Build::buildString() + std::string(")")), mediaFile);
