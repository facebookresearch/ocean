 ...
 * @defgroup applicationdemocvdetectorqrcodeosx FB Messenger Codes (OSX)
 * @{
 ...
 *
 * Examples:
 * open democvdetectorqrcode.app
 *
 * open democvdetectorqrcode.app -- args LiveVideoId:0 1280x720
 * @}
 */
