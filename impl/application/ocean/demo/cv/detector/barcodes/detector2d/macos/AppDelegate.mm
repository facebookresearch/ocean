...
#include "application/ocean/demo/cv/detector/barcodes/detector2d/macos/AppDelegate.h"
...
- (void)timerTicked:(NSTimer*)timer
{
	...
	wrapper.detectAndDecode(resultingFrame, qrCodePerformance, decodedMessages, &reachedLastFrame);
