...
#include "application/ocean/demo/cv/detector/calibrationpattern/win/CalibrationPattern.h"
...
{
	Messenger::get().setFileOutput("democvcalibrationpattern_output.txt");
	...
	try
	{
		CalibrationPatternMainWindow mainWindow(hInstance, String::toWString(std::string("Calibration pattern (") + Build::buildString() + std::string(")")), mediaFile);
