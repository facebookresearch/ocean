...
#ifndef FACEBOOK_APPLICATION_OCEAN_DEMO_CV_FRAME_FILTER_SCHARR_WIN_FRAME_FILTER_SCHARR_MAINWINDOW_H
#define FACEBOOK_APPLICATION_OCEAN_DEMO_CV_FRAME_FILTER_SCHARR_WIN_FRAME_FILTER_SCHARR_MAINWINDOW_H
 ...
 * @ingroup applicationdemocvframefilterscharrwin
 */
class FrameFilterScharrMainWindow :
	...
	virtual public Platform::Win::ApplicationWindow
{
	public:
		 ...
		 */
		FrameFilterScharrMainWindow(HINSTANCE instance, const std::wstring& name, const std::string& file = std::string());

		/**
		 * Destructs the main window.
		 */
		~FrameFilterScharrMainWindow() override;
...
#endif // FACEBOOK_APPLICATION_OCEAN_DEMO_CV_FRAME_FILTER_SCHARR_WIN_FRAME_FILTER_SCHARR_MAINWINDOW_H
