...
#include "application/ocean/demo/cv/framefilterscharr/win/FrameFilterScharr.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		FrameFilterScharrMainWindow mainWindow(hInstance, String::toWString(std::string("Scharr filter ")  + Build::buildString()).c_str(), mediaFile);
