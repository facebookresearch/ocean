...
#include "application/ocean/demo/cv/shrinker/win/Shrinker.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
...
#else
	const std::string frameworkPath(Ocean::Platform::System::environmentVariable("OCEAN_DEVELOPMENT_PATH"));
	...
	try
	{
		ShrinkerMainWindow mainWindow(hInstance, String::toWString(std::string("Shrinker (") + Build::buildString() + std::string(")")), mediaFile);
