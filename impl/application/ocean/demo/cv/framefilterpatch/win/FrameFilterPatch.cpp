...
#include "application/ocean/demo/cv/framefilterpatch/win/FrameFilterPatch.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		FrameFilterPatchMainWindow mainWindow(hInstance, String::toWString(std::string("Frame Filter Patch (") + Build::buildString() + std::string(")")), mediaFile);
