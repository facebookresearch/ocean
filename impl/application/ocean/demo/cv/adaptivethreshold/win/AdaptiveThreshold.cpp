...
#include "application/ocean/demo/cv/adaptivethreshold/win/AdaptiveThreshold.h"
...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nCmdShow*/)
{
	...
	try
	{
		AdaptiveThresholdMainWindow mainWindow(hInstance, String::toWString(std::string("Adaptive threshold (") + Build::buildString() + std::string(")")), mediaFile);
