...
class ImageView: NSImageView {
  ...
  func toggleView() {
    ...
    let rgbImageRef = CGImageCreate(800, 800, 8, 24, 800 * 3, CGColorSpaceCreateDeviceRGB(), CGBitmapInfo.ByteOrderDefault, provider, nil, false, kCGRenderingIntentDefault)
