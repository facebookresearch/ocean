...
#include "application/ocean/demo/tracking/planetracker/osx/AppDelegate.h"
...
- (void)applicationDidFinishLaunching:(NSNotification*)aNotification
{
	...
	planeTrackerWrapper_ = PlaneTrackerWrapper(Platform::Apple::MacOS::Utilities::commandArguments());
