 ...
 * @defgroup applicationdemotrackinghomographyimagealignermacos Homography Image Aligner (macOS)
 * @{
 ...
 * However, this application here is intended for Apple macOS platforms only.
