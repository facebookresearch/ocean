...
#ifndef FACEBOOK_APPLICATION_OCEAN_DEMO_TRACKING_HOMOGRAPHYIMAGEALIGNER_WIN_HOMOGRAPHY_IMAGE_ALIGNER_H
#define FACEBOOK_APPLICATION_OCEAN_DEMO_TRACKING_HOMOGRAPHYIMAGEALIGNER_WIN_HOMOGRAPHY_IMAGE_ALIGNER_H

#include "application/ocean/demo/tracking/ApplicationDemoTracking.h"

/**
 * @ingroup applicationdemotrackinghomographyimagealigner
 * @defgroup applicationdemotrackinghomographyimagealignerwin Homography Image Aligner (Windows)
 * @{
 ...
 *
 * Examples:
 * demotrackinghomographyimagealigner.exe
 *
 * demotrackinghomographyimagealigner.exe LiveVideoId:0 1280x720
 *
 * demotrackinghomographyimagealigner.exe anyMove.mp4 "" 80 15 4 128 8 3.0 RGB24 zeromean loop
 *
 * demotrackinghomographyimagealigner.exe imageSequence1.jpg
 * @}
 */

using namespace Ocean;

#endif // FACEBOOK_APPLICATION_OCEAN_DEMO_TRACKING_HOMOGRAPHYIMAGEALIGNER_WIN_HOMOGRAPHY_IMAGE_ALIGNER_H
