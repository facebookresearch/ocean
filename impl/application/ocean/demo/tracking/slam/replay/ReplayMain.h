...
#ifndef META_OCEAN_APPLICATION_OCEAN_DEMO_TRACKING_SLAM_REPLAY_REPLAY_MAIN_H
#define META_OCEAN_APPLICATION_OCEAN_DEMO_TRACKING_SLAM_REPLAY_REPLAY_MAIN_H
 ...
 * @defgroup applicationdemotrackingslamreplay SLAM Replay
 * @{
 * The demo application replays a serialized recording (.osn file) and runs the SLAM tracker on it.<br>
 * The application visualizes tracking results including feature tracks, gravity, and 3D map data,<br>
 * and outputs the visualization to a video file.
 *
 ...
 *
 * The SLAM tracker processes each frame and the application visualizes:<br>
 * - Feature tracks from the tracker<br>
 * - Gravity vector<br>
 * - 3D coordinate systems and map data when available
 *
 ...
 * applicationdemotrackingslamreplay
 */
class ScopedPlugin
{
	public:
...
#endif // META_OCEAN_APPLICATION_OCEAN_DEMO_TRACKING_SLAM_REPLAY_REPLAY_MAIN_H
