...
jboolean Java_com_facebook_ocean_app_demo_tracking_similaritytracker_android_SimilarityTrackerActivity_initializeSimilarityTracker(JNIEnv* env, jobject javaThis, jstring inputMedium, jstring resolution)
{
