 ...
 */
extern "C" jboolean Java_com_meta_ocean_app_demo_tracking_uvtexturemapping_android_UVTextureMappingActivity_initializeUVTextureMapping(JNIEnv* env, jobject javaThis, jstring inputMedium, jstring pattern, jstring resolution);
