...
#ifndef FACEBOOK_APPLICATION_OCEAN_DEMO_PLATFORM_MACOSOBJC_MACOS_WRAPPER_H
#define FACEBOOK_APPLICATION_OCEAN_DEMO_PLATFORM_MACOSOBJC_MACOS_WRAPPER_H

#include "application/ocean/demo/platform/ApplicationDemoPlatform.h"

/**
 * @ingroup applicationdemoplatform
 * @defgroup applicationdemoplatformmacosobjc macOS OBJC (macOS)
 * @{
 * The demo application demonstrates the implementation of a simple macOS window application based on Objective-C and Objective-C++.<br>
 ...
 * This application is platform dependent and is implemented for macOS platforms.
 * @}
 */

/**
 * Definition of a struct providing a two values.
 * @ingroup applicationdemoplatformmacosobjc
 */
struct Struct
{
	/// Integer value.
...
#endif // FACEBOOK_APPLICATION_OCEAN_DEMO_PLATFORM_MACOSOBJC_MACOS_WRAPPER_H
