 ...
 * Further, the application is based on Platform::Meta::Quest::OpenXR::VRNativeApplicationAdvanced.
 *
...
void android_main(struct android_app* androidApp)
{
	...
	OpenXRVRNativeApplicationAdvanced nativeApplication(androidApp);
