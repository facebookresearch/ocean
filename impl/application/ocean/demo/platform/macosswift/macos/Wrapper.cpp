...
#include "application/ocean/demo/platform/macosswift/macos/Wrapper.h"
...
static const char* string2buffer(const std::string& value)
{
...
{
	ocean_assert(selection != nullptr);
...
void oceanReleaseString(const char* value)
{
	...
	const void* memory = static_cast<const void*>(value);
