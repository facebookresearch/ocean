...
#ifndef FACEBOOK_APPLICATION_OCEAN_DEMO_PLATFORM_MACOSSWIFT_MACOS_WRAPPER_H
#define FACEBOOK_APPLICATION_OCEAN_DEMO_PLATFORM_MACOSSWIFT_MACOS_WRAPPER_H

/**
 * @ingroup applicationdemoplatform
 * @defgroup applicationdemoplatformmacosswiftmacos macOS Swift (macOS)
 * @{
 * The demo application demonstrates the implementation of a simple macOS window application based on swift.<br>
 * This application is platform dependent and is implemented for macOS platforms.<br>
 * @}
 */

/**
 * Definition of a struct providing a two values.
 * @ingroup applicationdemoplatformmacosswiftmacos
 */
struct Struct
{
	/// Integer value.
...
#endif // FACEBOOK_APPLICATION_OCEAN_DEMO_PLATFORM_MACOSSWIFT_MACOS_WRAPPER_H
