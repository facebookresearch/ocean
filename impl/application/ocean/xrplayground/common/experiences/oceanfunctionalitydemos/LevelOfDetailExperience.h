...
#ifndef META_APPLICATION_OCEAN_XRPLAYGROUND_COMMON_EXPERIENCES_LEVEL_OF_DETAIL_EXPERIENCE_H
#define META_APPLICATION_OCEAN_XRPLAYGROUND_COMMON_EXPERIENCES_LEVEL_OF_DETAIL_EXPERIENCE_H
...
/**
 * This experience shows how the LOD rendering node can be used in combination with a SLAM tracker.
 * @ingroup xrplayground
 */
class LevelOfDetailExperience : public XRPlaygroundExperience
{
	protected:
	...
	public:
		 ...
		 */
		~LevelOfDetailExperience() override;
	...
	protected:
		 ...
		 */
		LevelOfDetailExperience() = default;
...
#endif // META_APPLICATION_OCEAN_XRPLAYGROUND_COMMON_EXPERIENCES_LEVEL_OF_DETAIL_EXPERIENCE_H
