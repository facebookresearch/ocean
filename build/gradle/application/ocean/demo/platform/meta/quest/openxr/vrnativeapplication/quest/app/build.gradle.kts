...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/platform/meta/quest/openxr/vrnativeapplication/quest/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/demo/platform/meta/quest/openxr/vrnativeapplication/quest/OpenXRVRNativeApplicationActivity.java")
  ...
  copy {
    from(
        "$oceanDevelopmentPath/res/application/ocean/demo/platform/meta/quest/openxr/vrnativeapplication/quest/res")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.platform.meta.quest.openxr.vrnativeapplication.quest"
  compileSdk = 33
  ndkVersion = getEnv("ANDROID_NDK_VERSION")

  defaultConfig {
    applicationId = "com.meta.ocean.app.demo.platform.meta.quest.openxr.vrnativeapplication.quest"
    minSdk = 29
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets +=
            "application_ocean_demo_platform_meta_quest_openxr_vrnativeapplication_quest_native"
      }
    }
  }
