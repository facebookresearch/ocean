...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/base/console/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/base/console/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.base.console.android"
  compileSdk = 33
