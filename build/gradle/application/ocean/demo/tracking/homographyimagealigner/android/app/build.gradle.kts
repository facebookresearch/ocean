...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/homographyimagealigner/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourcesByPackage =
      mapOf(
          "com/meta/ocean/app/demo/tracking/homographyimagealigner/android" to
              listOf(
                  "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/homographyimagealigner/android/HomographyImageAlignerActivity.java"),
  ...
  copy {
    from(
        "$oceanDevelopmentPath/res/application/ocean/demo/tracking/homographyimagealigner/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.tracking.homographyimagealigner.android"
  compileSdk = 33
