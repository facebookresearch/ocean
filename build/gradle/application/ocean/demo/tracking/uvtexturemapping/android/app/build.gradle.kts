...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/uvtexturemapping/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/uvtexturemapping/android/UVTextureMappingActivity.java",
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/tracking/uvtexturemapping/android/res/")
    into("$resourcePath")
  }
  ...
  copy {
    from(
        "$oceanDevelopmentPath/res/application/ocean/demo/tracking/uvtexturemapping/android/assets/")
    into("$assetsPath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.tracking.uvtexturemapping.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.demo.tracking.uvtexturemapping.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_demo_tracking_uvtexturemapping_android_native"
      }
    }
  }
