...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/homographytracker/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourcesByPackage =
      mapOf(
          "com/meta/ocean/app/demo/tracking/homographytracker/android" to
              listOf(
                  "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/homographytracker/android/HomographyTrackerActivity.java"),
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/tracking/homographytracker/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.tracking.homographytracker.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.demo.tracking.homographytracker.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_demo_tracking_homographytracker_android_native"
      }
    }
  }
