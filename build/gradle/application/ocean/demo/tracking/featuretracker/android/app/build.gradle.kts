...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/featuretracker/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourcesByPackage =
      mapOf(
          "com/meta/ocean/app/demo/tracking/featuretracker/android" to
              listOf(
                  "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/featuretracker/android/FeatureTrackerActivity.java"),
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/tracking/featuretracker/android/res/")
    into("$resourcePath")
  }
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/tracking/featuretracker/android/assets/")
    into("$assetsPath")
  }
