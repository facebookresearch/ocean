...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/similaritytracker/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourcesByPackage =
      mapOf(
          "com/meta/ocean/app/demo/tracking/similaritytracker/android" to
              listOf(
                  "$oceanDevelopmentPath/impl/application/ocean/demo/tracking/similaritytracker/android/SimilarityTrackerActivity.java"),
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/tracking/similaritytracker/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.tracking.similaritytracker.android"
  compileSdk = 33
  ...
  defaultConfig {
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_demo_tracking_similaritytracker_android_native"
      }
    }
  }
