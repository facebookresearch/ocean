...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/cv/detector/messengercode/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourcesByPackage =
      mapOf(
          "com/meta/ocean/app/demo/cv/detector/messengercode/android" to
              listOf(
                  "$oceanDevelopmentPath/impl/application/ocean/demo/cv/detector/messengercode/android/MessengerCodeActivity.java"),
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/cv/detector/messengercode/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.cv.detector.messengercode.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.demo.cv.detector.messengercode.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
