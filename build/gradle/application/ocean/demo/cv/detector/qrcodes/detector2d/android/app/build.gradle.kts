...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/cv/detector/qrcodes/detector2d/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourcesByPackage =
      mapOf(
          "com/meta/ocean/app/demo/cv/detector/qrcodes/detector2d/android" to
              listOf(
                  "$oceanDevelopmentPath/impl/application/ocean/demo/cv/detector/qrcodes/detector2d/android/Detector2DActivity.java"),
  ...
  copy {
    from(
        "$oceanDevelopmentPath/res/application/ocean/demo/cv/detector/qrcodes/detector2d/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.cv.detector.qrcodes.detector2d.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.demo.cv.detector.qrcodes.detector2d.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
