...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/media/questcamera/quest/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourcesByPackage =
      mapOf(
          "com/meta/ocean/app/demo/media/questcamera/quest" to
              listOf(
                  "$oceanDevelopmentPath/impl/application/ocean/demo/media/questcamera/quest/QuestCameraApplicationActivity.java"),
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/media/questcamera/quest/res")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.media.questcamera.quest"
  compileSdk = 33
  ndkVersion = getEnv("ANDROID_NDK_VERSION")

  defaultConfig {
    applicationId = "com.meta.ocean.app.demo.media.questcamera.quest"
    minSdk = 30
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_demo_media_questcamera_quest_native"
      }
    }
  }
