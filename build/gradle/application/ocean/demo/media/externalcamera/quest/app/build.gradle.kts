...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/media/externalcamera/quest/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourcesByPackage =
      mapOf(
          "com/meta/ocean/app/demo/media/externalcamera/quest" to
              listOf(
                  "$oceanDevelopmentPath/impl/application/ocean/demo/media/externalcamera/quest/ExternalCameraApplicationActivity.java"),
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/media/externalcamera/quest/res")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.media.externalcamera.quest"
  compileSdk = 33
  ndkVersion = getEnv("ANDROID_NDK_VERSION")

  defaultConfig {
    applicationId = "com.meta.ocean.app.demo.media.externalcamera.quest"
    minSdk = 30
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
