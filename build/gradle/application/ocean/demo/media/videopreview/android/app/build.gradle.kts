...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/demo/media/videopreview/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/demo/media/videopreview/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.demo.media.videopreview.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.demo.media.videopreview.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
