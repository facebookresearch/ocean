...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/test/cv/testcv/testdetector/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/test/cv/testcv/testdetector/android/TestCVDetectorActivity.java",
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/test/cv/testcv/testdetector/android/res/")
    into("$resourcePath")
  }
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/test/cv/testcv/testdetector/android/assets/")
    into("$assetsPath")
  }
...
android {
  namespace = "com.meta.ocean.app.test.cv.testcv.testdetector.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.test.cv.testcv.testdetector.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
