...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/test/cv/testcv/testdetector/testqrcodes/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/test/cv/testcv/testdetector/testqrcodes/android/TestCVDetectorQRCodesActivity.java",
  ...
  copy {
    from(
        "$oceanDevelopmentPath/res/application/ocean/test/cv/testcv/testdetector/testqrcodes/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.test.cv.testcv.testdetector.testqrcodes.android"
  compileSdk = 33
  ...
  defaultConfig {
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_test_cv_testcv_testdetector_testqrcodes_android_native"
      }
    }
  }
