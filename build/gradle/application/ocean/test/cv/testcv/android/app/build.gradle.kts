...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/test/cv/testcv/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/test/cv/testcv/android/TestCVActivity.java",
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/test/cv/testcv/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.test.cv.testcv.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.test.cv.testcv.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_test_cv_testcv_android_native"
      }
    }
  }
