...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/test/network/testnetwork/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/test/network/testnetwork/android/TestNetworkActivity.java",
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/test/network/testnetwork/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.test.network.testnetwork.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.test.network.testnetwork.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_test_network_testnetwork_android_native"
      }
    }
  }
