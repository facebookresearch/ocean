...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/test/base/testbase/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/test/base/testbase/android/TestBaseActivity.java",
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/test/base/testbase/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.test.base.testbase"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.test.base.testbase"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_test_base_testbase_android_native"
      }
    }
  }
