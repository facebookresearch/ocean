...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/test/geometry/testgeometry/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/test/geometry/testgeometry/android/TestGeometryActivity.java",
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/test/geometry/testgeometry/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.test.geometry.testgeometry.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.test.geometry.testgeometry.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_test_geometry_testgeometry_android_native"
      }
    }
  }
