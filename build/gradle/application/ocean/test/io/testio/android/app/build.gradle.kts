...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/test/io/testio/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/test/io/testio/android/TestIOActivity.java",
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/test/io/testio/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.test.io.testio.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.test.io.testio.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_test_io_testio_android_native"
      }
    }
  }
