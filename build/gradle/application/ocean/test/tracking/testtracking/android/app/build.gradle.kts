...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/test/tracking/testtracking/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/test/tracking/testtracking/android/TestTrackingActivity.java",
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/test/tracking/testtracking/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.test.tracking.testtracking.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.test.tracking.testtracking.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_test_tracking_testtracking_android_native"
      }
    }
  }
