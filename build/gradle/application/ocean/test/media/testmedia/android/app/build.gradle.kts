...
tasks.register("copyTemporaryFiles") {
  ...
  copy {
    from(
        file(
            "$oceanDevelopmentPath/impl/application/ocean/test/media/testmedia/android/AndroidManifest.xml"))
    into(sourcePath)
  }
  ...
  val javaSourceFiles =
      listOf(
          "$oceanDevelopmentPath/impl/application/ocean/test/media/testmedia/android/TestMediaActivity.java",
  ...
  copy {
    from("$oceanDevelopmentPath/res/application/ocean/test/media/testmedia/android/res/")
    into("$resourcePath")
  }
...
android {
  namespace = "com.meta.ocean.app.test.media.testmedia.android"
  compileSdk = 33

  defaultConfig {
    applicationId = "com.meta.ocean.app.test.media.testmedia.android"
    minSdk = 33
    targetSdk = 33
    versionCode = 1
    versionName = "1.0"
    ...
    externalNativeBuild {
      cmake {
        ...
        targets += "application_ocean_test_media_testmedia_android_native"
      }
    }
  }
