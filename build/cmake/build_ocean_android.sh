...
# Shared builds are currently unused.  Typical Android app uses a single shared library created from linking static builds of Ocean and third-party libraries.
