...
cmake -S %OCEAN_SOURCE_DIR% -B C:\tmp\ocean_build_static -DCMAKE_INSTALL_PREFIX=C:\tmp\ocean_install_static
...
cmake -S %OCEAN_SOURCE_DIR% -B C:\tmp\ocean_build_shared -DCMAKE_INSTALL_PREFIX=C:\tmp\ocean_install_shared -DBUILD_SHARED_LIBS=ON
