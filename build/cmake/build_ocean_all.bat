...
cmake -S %OCEAN_SOURCE_DIR% -B C:\tmp\ocean_build_static -DCMAKE_INSTALL_PREFIX=C:\tmp\ocean_install_static -DCMAKE_CONFIGURATION_TYPES="Debug;Release" -DOCEAN_BUILD_THIRD_PARTY_LIBS=TRUE
...
cmake -S %OCEAN_SOURCE_DIR% -B C:\tmp\ocean_build_shared -DCMAKE_INSTALL_PREFIX=C:\tmp\ocean_install_shared -DCMAKE_CONFIGURATION_TYPES="Debug;Release" -DBUILD_SHARED_LIBS=ON -DOCEAN_BUILD_THIRD_PARTY_LIBS=TRUE
