...
function run_build {
    ...
    BUILD_DIR="${OCEAN_BUILD_DIR}/${OCEAN_PLATFORM}/${IOS_CMAKE_TOOLCHAIN_PLATFORM}_${LINKING_TYPE}_${BUILD_CONFIG}"
    INSTALL_DIR="${OCEAN_INSTALL_DIR}/${OCEAN_PLATFORM}/${IOS_CMAKE_TOOLCHAIN_PLATFORM}_${LINKING_TYPE}_${BUILD_CONFIG}"
    ...
    if [ -n "${OCEAN_THIRD_PARTY_DIR}" ]; then
        ...
        THIRD_PARTY_DIR="${OCEAN_THIRD_PARTY_DIR}/${OCEAN_PLATFORM}/${IOS_CMAKE_TOOLCHAIN_PLATFORM}_${LINKING_TYPE}_${BUILD_CONFIG}"
