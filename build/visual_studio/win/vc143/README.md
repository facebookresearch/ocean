...
|-----------|----------|-------------|
| `win\vc143` | Windows | Windows desktop builds |
| `android\vc143` | Android | Android builds via Visual Studio |
...
.\generate_reference_props.ps1 -RootPath ".\android\vc143"
```
...
5. **Add the project to `win_vc143.sln`**
