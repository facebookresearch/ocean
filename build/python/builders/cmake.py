...
class CMakeBuilder(Builder):
    ...
    def _build_configure_command(self, ctx: BuildContext) -> List[str]:
        ...
        # Cross-compilation settings. Shared with build_ocean.py so Ocean and
        # its third-party libraries cannot be configured for different targets.
        add_cross_compile_options(cmd, ctx.target, ctx.android_api_level)
