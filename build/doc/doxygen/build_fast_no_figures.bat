...
@echo Building the documentation (without figures) for:
@echo.

@echo Ocean

del /Q ocean\ocean_doxygen.log
call python3 ocean\build.nopy nofigures
start cmd /C ocean\ocean_doxygen.log

@echo Application Ocean
del /Q application\ocean\application_ocean_doxygen.log
call python3 application\ocean\build.nopy nofigures
...
call python3 interaction\javascript\build.nopy nofigures
